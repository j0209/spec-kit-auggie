...
EOF
    ...
    local spec_count=$(find "$export_project_dir" -name "*.md" | wc -l)

    echo "✅ Export complete!"
    echo "📊 Exported $spec_count specification files"
    echo "📁 Location: $export_project_dir"
    echo ""
    echo "🎉 Specification package ready for development handoff!"
}
